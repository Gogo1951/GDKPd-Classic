...
L["New highest bidder on %s: %s (%d gold)"] = "新最高出价 于物品 %s: %s (%d gold)"
L["Invalid. %s please bid at least %d gold on %s."] = "非法竞价. %s 请最少出价 %d gold 于物品 %s."
L["[Caution] %d seconds remaining on %s. Current bid %s (%d gold); bid at least %d gold!"] = "[注意] %d 秒剩余 于物品 %s. 当前最高出价 %s (%d gold); 最低竞价 %d gold!"
L["[Caution] %d seconds remaining on %s. Bid at least %d gold!"] = "[注意] %d 秒剩余 于物品 %s. 最低竞价 %d gold!"
L["[Caution] "] = "[注意] "
