...
L["Bidding starts on %s. Please bid in raid chat, starting bid %d gold, minimum increment %d gold."] = "开始拍卖 %s. 请在团队频道出价, 起拍价 %d gold, 最低加价 %d gold."
L["Bidding starts on %s. Bid using format '[item] 1000', starting bid %d gold, minimum increment %d gold. TTL: %d/%d"] = "开始拍卖 %s. 出价格式 '[item] 1000', 起拍价 %d gold, 最低加价 %d gold. TTL: %d/%d"
L["New highest bidder on %s: %s (%d gold)"] = "新最高出价 于物品 %s: %s (%d gold)"
L["New highest bidder: %s (%d gold)"] = "新最高出价: %s (%d gold)"
L["Auction cancelled for %s."] = "以下物品拍卖取消 %s."
L["Auction cancelled."] = "拍卖取消."
L["Auction finished for %s. Winner: %s. %s."] = "以下物品拍卖结束 %s. 中拍者: %s. %s."
L["Current pot: "] = "当前累计收入: "
L["Auction finished for %s. No bids recieved."] = "以下物品拍卖结束 %s. 流拍."
L["Auction finished. Winner: %s. %s."] = "拍卖结束. 中拍者: %s. %s."
L["Auction finished. No bids recieved."] = "拍卖结束. 流拍."
L["Distributing pot. Pot size: %d gold. Amount to distribute: %d gold. Players in raid: %d(%d). Share per player: %d gold."] = "收入情况通报. 累计收入: %d gold. 分配金额: %d gold. 分配人数: %d(%d). 人均收入: %d gold."
L["Distributing pot. Pot size: %d gold. Amount to distribute: %d gold. Players in raid: %d. Share per player: %d gold."] = "收入情况通报. 累计收入: %d gold. 分配金额: %d gold. 分配人数: %d. 人均收入: %d gold."
L["New highest bidder: %s (%d gold)"] = "新最高出价: %s (%d gold)"
L["Invalid. %s please bid at least %d gold on %s."] = "非法竞价. %s 请最少出价 %d gold 于物品 %s."
L["New highest bidder on %s: %s (%d gold)"] = "新最高出价 于物品 %s: %s (%d gold)"
L["Invalid. %s please bid at least %d gold on %s."] = "非法竞价. %s 请最少出价 %d gold 于物品 %s."
L["[Caution] %d seconds remaining on %s. Current bid %s (%d gold); bid at least %d gold!"] = "[注意] %d 秒剩余 于物品 %s. 当前最高出价 %s (%d gold); 最低出价 %d gold!"
L["[Caution] %d seconds remaining on %s. Bid at least %d gold!"] = "[注意] %d 秒剩余 于物品 %s. 最低出价 %d gold!"
L["[Caution] "] = "[注意] "
L[" seconds remaining!"] = " 秒剩余!"
L[" seconds remaining for item "] = " 秒剩余 于物品 "

-- Message Match Localization
L["Bidding starts on (|c........|Hitem:.+|r). Please bid in raid chat, starting bid (%d+) gold, minimum increment (%d+) gold. TTL: (%d+)/(%d+)"] = "开始拍卖 (|c........|Hitem:.+|r). 请在团队频道出价, 起拍价 (%d+) gold, 最低加价 (%d+) gold. TTL: (%d+)/(%d+)"
L["Bidding starts on (|c........|Hitem:.+|r). Please bid in raid chat, starting bid (%d+) gold, minimum increment (%d+) gold. TTL until expire: (%d+) seconds, TTL after bid: (%d+) seconds."] = "开始拍卖 (|c........|Hitem:.+|r). 请在团队频道出价, 起拍价 (%d+) gold, 最低加价 (%d+) gold. 初始拍卖时限: (%d+) 秒, 出价刷新时限: (%d+) 秒."
L["Bidding starts on (|c........|Hitem:.+|r). Please bid in raid chat, starting bid (%d+) gold, minimum increment (%d+) gold. TTL after a bid is placed: (%d+) seconds."] = "开始拍卖 (|c........|Hitem:.+|r). 请在团队频道出价, 起拍价 (%d+) gold, 最低加价 (%d+) gold. 出价后刷新时限: (%d+) 秒."
L["Bidding starts on (|c........|Hitem:.+|r). Please bid in raid chat, starting bid (%d+) gold, minimum increment (%d+) gold."] = "开始拍卖 (|c........|Hitem:.+|r). 请在团队频道出价, 起拍价 (%d+) gold, 最低加价 (%d+) gold."
L["Bidding starts on (|c........|Hitem:.+|r). Bid using format '%[item%] 1000', starting bid (%d+) gold, minimum increment (%d+) gold. TTL: (%d+)/(%d+)"] = "开始拍卖 (|c........|Hitem:.+|r). 出价格式 '%[item%] 1000', 起拍价 (%d+) gold, 最低加价 (%d+) gold. TTL: (%d+)/(%d+)"
L["Bidding starts on (|c........|Hitem:.+|r). Bid using format '%[item%] 1000', starting bid (%d+) gold, minimum increment (%d+) gold. TTL until expire: (%d+) seconds, TTL after bid: (%d+) seconds."] = "开始拍卖 (|c........|Hitem:.+|r). 出价格式 '%[item%] 1000', 起拍价 (%d+) gold, 最低加价 (%d+) gold. 初始拍卖时限: (%d+) 秒, 出价刷新时限: (%d+) 秒."
L["Bidding starts on (|c........|Hitem:.+|r). Please bid in raid chat, using format 'itemlink bid'. Starting bid (%d+) gold, minimum increment (%d+) gold. TTL after a bid is placed: (%d+) seconds."] = "开始拍卖 (|c........|Hitem:.+|r). 请在团队频道出价, 出价格式 'itemlink bid'. 起拍价 (%d+) gold, 最低加价 (%d+) gold. 出价后刷新时限: (%d+) 秒."
L["New highest bidder: (%S+) %((%d+) gold%)"] = "新最高出价: (%S+) %((%d+) gold%)"
L["New highest bidder on (|c........|Hitem:.+|r): (%S+) %((%d+) gold%)"] = "新最高出价 于物品 (|c........|Hitem:.+|r): (%S+) %((%d+) gold%)"
L["Auction finished. Winner: (%S+). (.+)."] = "拍卖结束. 中拍者: (%S+). (.+)."
L["Auction finished for (|c........|Hitem:.+|r)."] = "以下物品拍卖结束 (|c........|Hitem:.+|r)."
L["Auction finished for |c........|Hitem:.+|r%. Winner: (%S+)%. (.+)"] = "以下物品拍卖结束 |c........|Hitem:.+|r%. 中拍者: (%S+)%. (.+)"
L["Auction cancelled for (|c........|Hitem:.+|r)%."] = "以下物品拍卖取消 (|c........|Hitem:.+|r)%."
L["Distributing pot. Pot size: %d+ gold. Amount to distribute: %d+ gold. Players in raid: %d+. Share per player: (%d+) gold."] = "收入情况通报. 累计收入: %d+ gold. 分配金额: %d+ gold. 分配人数: %d+. 人均收入: (%d+) gold."
L["Distributing pot. Pot size: %d+ gold. Players in raid: %d+. Pot share per player: (%d+) gold."] = "收入情况通报. 累计收入: %d+ gold. 分配人数: %d+. Pot 人均收入: (%d+) gold."
L["New highest bidder(.*): (%S+) %((%d+) gold%)"] = "新最高出价(.*): (%S+) %((%d+) gold%)"
L["Auction finished"] = "拍卖结束"
L["Auction cancelled"] = "拍卖取消"
L["Auction finished."] = "拍卖结束."
L["Auction cancelled."] = "拍卖取消."
L["%[Caution%] (%d+) seconds remaining(.*)!"] = "%[注意%] (%d+) 秒剩余(.*)!"
L["seconds remaining"] = "秒剩余"
L["Current pot: (%d+) gold"] = "当前累计收入: (%d+) gold"
L["Invalid%. (.+) please bid at least (%d+) gold on (|c........|Hitem:.+|r)."] = "非法竞价%. (.+) 请最少出价 (%d+) gold 于物品 (|c........|Hitem:.+|r)."
L["Bidding starts on (|c........|Hitem:.+|r)."] = "开始拍卖 (|c........|Hitem:.+|r)."